...
- **1b.** Introduction to probability
    ...
    - Frequentist versus Bayesian view on probability

<span style = "color:white"></span>
    
- **2.** Foundation: Statistical models
    - Bread and butter example
    - A history of misconceptions: *p*-values and confidence intervals
...
- **4a.** Some applications of Bayesian principles
...
"We are inclined to think that as far as a particular hypothesis is concerned, no test based upon the the-
ory of probability can by itself provide any valuable evidence of the truth or falsehood of that hypothesis. But we may look at the purpose of tests from another view-point. Without hoping to know whether each separate hypothesis is true or false, we may search for rules to govern our behaviour with regard to them, in following which we insure that, in the long run of experience, we shall not be too often wrong".
...
## A murder mistery: Prior beliefs
+-----------------------+-------------------------------+--------------------------+-----------------------------+
|                       |$\text{He killed himself}$     |  $\text{She killed him}$ | $\text{Butler killed him}$  |
+-----------------------+-------------------------------+--------------------------+-----------------------------+
| $\text{Used axe}$     |  $\frac{1}{12}$               | $\frac{1}{12}$           | $\frac{2}{12}$              |
...
## A murder mistery: Posterior beliefs
+--------------------------+----------------------------+--------------------------+-----------------------------+
|                          |$\text{He killed himself}$  |  $\text{She killed him}$ | $\text{Butler killed him}$  |
+--------------------------+----------------------------+--------------------------+-----------------------------+
...
<span style = "font-size: 2em; line-height: 120%; margin-top: -500px;">
...
## Simulator sickness and age
- The model I suggested is actually wrong (just look at the distribution of age)
- Additionally, Pearson correlation does not require Gaussian random variables
