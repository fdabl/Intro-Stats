...
b. What is the difference between prior, likelihood, and posterior?
c. What is a Bayes factor? How do you compute it?
...
## Coin flips
Is the damn coin fair, or is it not? Assume you observe the data
```{r, echo = FALSE}
c(1, 1, 1, 1, 1)
```

a. Draw the Gaussian graphical model and your prior specification.
...
## Univariate Gaussian, Variance known
